...
<html>
	...
	<body>
			...
			<div class="row">
				...
				<div class="welcome-edge col-lg-3">
					...
					<div class="panel panel-default contact-panel">
						...
						<div class="panel-body">
							<p>QQ：123456</p>
							<p>更多模板：<a href="http://www.aspku.com/" target="_blank">源码之家</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<script src="../../admin/static/admin/lib/echarts/echarts.js"></script>
		<script type="text/javascript">
			layui.use(['layer','jquery'], function(){
				...
				require.config({
				    paths: {
				        echarts: '../../admin/static/admin/lib/echarts'
				    }
				});
				require(
				    [
